...
function Uc(e, n, t, r, l, o, i, u, s) {
  (Et = !1), (Rr = null), Ic.apply(Fc, arguments);
}
...
function bo(e, n, t, r) {
  if (Dr) {
    var l = co(e, n, t, r);
    if (l === null) Ml(e, n, r, Ir, t), Yi(e, r);
...
var Pf = We && "TextEvent" in window && !Ct,
...
function Of(e, n, t) {
  e === "focusin"
    ? (ru(), (_t = n), (Ft = t), _t.attachEvent("onpropertychange", As))
    : e === "focusout" && ru();
}
function Mf(e) {
      ...
      N &&
        (Ds &&
          ...
          (In || N !== "onCompositionStart"
            ? N === "onCompositionEnd" && In && (_ = Ms())
            : ((nn = h),
              (ei = "value" in nn ? nn.value : nn.textContent),
              (In = !0))),
        (C = Fr(c, N)),
        0 < C.length &&
          ((N = new Ji(N, e, null, t, h)),
          m.push({ event: N, listeners: C }),
          _ ? (N.data = _) : ((_ = Fs(t)), _ !== null && (N.data = _)))),
        (_ = Pf ? zf(e, t) : Lf(e, t)) &&
...
function ia(e) {
  ...
  function S(f, a, d, v) {
    ...
    if (T.done) return t(f, _), U && wn(f, N), x;
    if (_ === null) {
      for (; !T.done; N++, T = d.next())
        (T = m(f, T.value, v)),
          T !== null &&
            ((a = o(T, a, N)), C === null ? (x = T) : (C.sibling = T), (C = T));
      return U && wn(f, N), x;
    }
...
function nd(e, n, t) {
  ...
  if (_a(e)) Na(n, l);
    ...
    (t = ta(e, n, l, r)),
      t !== null && ((l = ie()), je(t, e, r, l), Pa(t, n, r));
  }
}
function _a(e) {
  var n = e.alternate;
  ...
  if (((u = (i & e.childLanes) !== 0), ce || u)) {
    if (((r = J), r !== null)) {
      ...
      (l = l & (r.suspendedLanes | i) ? 0 : l),
        l !== 0 &&
          l !== o.retryLane &&
          ((o.retryLane = l), Ke(e, l), je(r, e, l, -1));
    }
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Jo(n, t | 1), pe(n, Q()), !(R & 6) && ((lt = Q() + 500), vn()));
      }
      break;
    case 13:
      Tn(function () {
    ...
    return j.jsx("div", {
      ...
      children: j.jsxs("div", {
        ...
        children: [
          ...
          j.jsx("div", {
            className:
              "relative ml-3 text-sm bg-white py-2 px-4 shadow rounded-xl text-left",
            children: j.jsx("div", { children: e.message.content }),
          }),
        ],
      }),
    });
    ...
    return j.jsx("div", {
      ...
      children: j.jsxs("div", {
        ...
        children: [
          j.jsx("div", {
            className:
              "flex items-center justify-center h-10 w-10 rounded-full bg-purple-500 flex-shrink-0",
            children: "U",
          }),
          j.jsx("div", {
            className:
              "relative mr-3 text-sm bg-indigo-100 py-2 px-4 shadow rounded-xl text-left",
            children: j.jsx("div", { children: e.message.content }),
          }),
        ],
      }),
    ...
    try {
      const m = await (
        await fetch("http://localhost:4000/chat", {
          ...
          body: JSON.stringify({ messages: s, state: c }),
        })
      ).json();
      console.log(m), o([...s, m.botResponse]), r(m.newState);
    } catch (h) {
      console.error("Failed to send chat history:", h);
    }
  }
  return j.jsx("div", {
          ...
          children: [
            j.jsx("div", {
              ...
              children: j.jsxs("div", {
                ...
                children: [
                  l.map((s, c) => j.jsx(Rd, { message: s }, c)),
                  j.jsx("div", { ref: i }),
                ],
              }),
            }),
...
Ql.createRoot(document.getElementById("root")).render(
  j.jsx(wc.StrictMode, { children: j.jsx(jd, {}) })
);
